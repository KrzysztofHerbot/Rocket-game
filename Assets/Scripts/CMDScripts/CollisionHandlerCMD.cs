...
public class CollisionHandlerCMD : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (mv.fuel + FuelCollected < Autopilot.maxfuel)
            {
                mv.fuel = mv.fuel + FuelCollected;
            }
            else mv.fuel = Autopilot.maxfuel;
        }
...
void StartCrash()
    {
        ...
        LoseParticles.Play();
        GetComponent<Autopilot>().enabled = false;
